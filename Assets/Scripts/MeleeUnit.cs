...
using UnityEngine;
    ...
    class MeleeUnit : Unit
    {
      ...
      /*  protected string name;
       ...
       protected char symbol;
        ...
        public MeleeUnit(string pic ,int health ,char team, char sym) : base( 100, 15, 1, 1)
        {
        ...
        {
            if (inRange(enemy) == true) //this range check may seem unneccessary, but these things were like snipers without it
            {
                enemy.propHp = enemy.propHp - this.propAttack;
                Debug.Log("my position" + this.propX + this.propY + " enemy position " + enemy.propX + enemy.propY);
            }
        }
    ...
    public override Building closestBuilding(Building[] buildArray)                  //methods to target buildings
    {
