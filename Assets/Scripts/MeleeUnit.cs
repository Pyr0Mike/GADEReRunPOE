    ...
    class MeleeUnit : Unit
    {
      ...
      /*  public string propName
       ...
       //protected char symbol;
        ...
        public MeleeUnit(int health ,char team, char sym) : base( 100, 15, 1, 1)
        {
        ...
        public override void combat(Unit enemy)  // combat method
        {
            if (inRange(enemy) == true) //this range check may seem unneccessary, but these things were like snipers without it
            {
                ...
                Console.WriteLine("my position" + this.propX + this.propY + " enemy position " + enemy.propX + enemy.propY);
            }
        }
